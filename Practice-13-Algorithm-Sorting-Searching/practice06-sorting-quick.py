def quick_sort(numbers, start, end):
    if start < end:
        ...
        quick_sort(numbers, start, p - 1)  # Os menores à esquerda
        quick_sort(numbers, p + 1, end)  # Os maiores à direita
...
def partition(numbers, start, end):
    ...
    for index in range(start, end):
        # o índice será analisado no momento e passará por todos os elementos
